...
declare namespace TJ.Develop.Yun.Rank {
    ...
    function ReportScore(rankguid: string, score: number): Promise<void>;
}
...
declare namespace TJ.ADS {
    ...
    class Api {
        ...
        static NormalReady(param: Param): any;
        static ShowNormal(param: Param): void;
        static RewardReady(param: Param): any;
        static ShowReward(param: Param): void;
        static readonly exist: any;
    }
}
