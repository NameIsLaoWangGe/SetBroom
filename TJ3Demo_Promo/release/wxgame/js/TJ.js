...
中国标准时间 2020/6/8 18:46:44
*/
var DP;
(function (DP) {
    var Basic;
    (function (Basic) {
        Basic.appGuid = "07ee2bf1-02e3-b103-4ade-782622f67fe3";
        Basic.companyName = "苏州番茄互娱信息科技有限公司";
        Basic.productName = "飞跃彩虹岛";
        Basic.packageName = "com.tomatojoy.fychd.wx";
        Basic.versionName = "0.0.1";
        Basic.versionCode = 2;
        Basic.channel = "WX_AppRt";
    ...
    var WX;
    (function (WX) {
        WX.appId = "wxb700714e1d514fa6";
        WX.bannerId = "adunit-8cbc8dbe514ecb1e";
        WX.insertId = "adunit-c3b038b514504c54";
        WX.videoId = "adunit-c3d18ac0581d54a0";
    })(WX = DP.WX || (DP.WX = {}));
    var VIVO;
    (function (VIVO) {
        var QG;
    ...
    var ReYun;
    (function (ReYun) {
        ReYun.appId = "731be1710914aae7c0d2ae9071f2f99d";
    ...
    (function (Common) {
        ...
        (function (Prefs) {
            ...
            (function (Raw) {
                ...
                function Keys() {
                    var keys = [];
                    for (var _i = 0, _a = TJ.Engine.LocalStorage.keys; _i < _a.length; _i++) {
                        var key = _a[_i];
    ...
    (function (Develop) {
        ...
        (function (Yun) {
            ...
            (function (Rank) {
                ...
                function ReportScore(rankguid, score) {
                    return __awaiter(this, void 0, void 0, function () {
                        var req, p, www;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
            ...
            (function (Extern) {
                ...
                (function (OPPO) {
                    ...
                    (function (QG) {
                        ...
                        //检测游戏崩溃等异常检测  打包以及测试平台版本 不小于1060 
                        function ReportMonitor(name, value) {
                            //进入主界面的生命周期时调用一次 目前上报数据只支持 (‘game_scene’， 0)
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (www.error == null) {
                                                res = JSON.parse(www.text);
                                                if (res.E == null) {
                                                    return [2 /*return*/, res.P.userInfo];
                                                }
                                                else {
                                                    console.log("E = " + res.E);
                                                }
